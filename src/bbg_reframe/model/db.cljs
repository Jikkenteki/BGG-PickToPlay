(ns bbg-reframe.model.db
  (:require   
              [bbg-reframe.model.xmlapi :refer [game-attribute game-id
                                                game-name game-rating game-my-rating
                                                create-votes-for-results list-results-of-votes-per-playernum]]
...
(defn game-votes
  ...
  (into [] (map create-votes-for-results
                (list-results-of-votes-per-playernum game))))
